...
using MacroWatch.Tray;

namespace MacroWatch;
...
internal static class Program
{
    ...
    private static void Main()
    {
        ...
        Application.Run(new MacroWatchApplicationContext(configStore, eventLog, startup, monitorCatalog, capture, uploader));
